...
import { User, Bell, Shield, CreditCard, Users, Key, ArrowLeft, Bot } from 'lucide-react';
...
const sections = [
  ...
  { id: 'team' as SectionId, title: 'Team', icon: Users, desc: 'Manage team members & roles (7 seats)', color: 'var(--mint)' },
  ...
  { id: 'api' as SectionId, title: 'API Keys', icon: Key, desc: 'Shared group API keys with encryption at rest', color: 'var(--cyan)' },
];
    ...
    <div className="h-full bg-transparent overflow-auto">
      <div className="max-w-7xl mx-auto px-8 py-8">
        <div className="mb-10">
          ...
          <p className="text-sm text-[var(--muted)]">Growth Plan — 7 seats • Team collaboration enabled</p>
        </div>
