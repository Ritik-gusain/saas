...
export default function DashboardLayout({
  ...
  const navItems = [
    { id: 'chat', label: 'Chat', icon: MessageSquare, href: '/dashboard/starter', expandable: true },
    { id: 'projects', label: 'Projects', icon: FolderKanban, href: '/dashboard/starter/projects', expandable: false },
    { id: 'analytics', label: 'Analytics', icon: BarChart3, href: '/dashboard/starter/analytics', expandable: false },
    { id: 'settings', label: 'Settings', icon: Settings, href: '/dashboard/starter/settings', expandable: false },
  ];
      ...
      <div className="flex h-screen bg-[var(--bg)] text-[var(--soft)] font-['Plus_Jakarta_Sans'] relative overflow-hidden">
        ...
        <div className="w-72 glass-panel border-r flex flex-col z-10 relative">
          ...
          <div className="p-6 border-b border-[var(--border)]">
            <div className="flex items-center gap-3 group cursor-pointer" onClick={() => router.push('/dashboard/starter')}>
