...
export default function DashboardLayout({
  ...
  const navItems = [
    ...
    { id: 'projects', label: 'Projects', icon: FolderKanban, href: '/dashboard/projects', expandable: false },
    { id: 'analytics', label: 'Analytics', icon: BarChart3, href: '/dashboard/analytics', expandable: false },
    { id: 'settings', label: 'Settings', icon: Settings, href: '/dashboard/settings', expandable: false },
  ];
