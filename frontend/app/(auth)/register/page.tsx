...
export default function RegisterPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[var(--bg)] relative overflow-hidden font-['DM_Sans'] text-[var(--soft)]">
      ...
      <div className="absolute top-0 right-0 w-[800px] h-[500px] bg-radial-gradient from-[var(--cyan)]/10 via-[var(--cyan)]/5 to-transparent rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[400px] bg-radial-gradient from-[var(--mint)]/5 to-transparent rounded-full blur-[80px] pointer-events-none animate-float" />
      ...
      <div className="flex-1 flex items-center justify-center p-6 relative z-10 lg:-mt-10">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8 space-y-2">
            <h2 className="text-3xl font-black text-white tracking-tight font-[Syne]">Initialize Account</h2>
            <p className="text-[var(--soft)]/60 text-sm uppercase tracking-widest font-bold">New Operator Registration</p>
          </div>
          ...
          <div className="bg-[var(--hud)]/20 border border-[var(--border)] backdrop-blur-xl p-8 rounded-2xl shadow-2xl shadow-black/50">
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold text-[var(--soft)] uppercase tracking-[0.2em]">Full Name</label>
              ...
              <button 
                type="submit" 
                disabled={loading} 
                className="w-full py-3.5 mt-4 flex items-center justify-center gap-2 bg-gradient-to-br from-[var(--cyan)] to-[var(--mint)] text-[var(--bg)] font-black text-sm rounded-xl shadow-lg shadow-[var(--cyan)]/20 transition-all active:scale-[0.98] disabled:opacity-30 disabled:cursor-not-allowed group uppercase tracking-[0.1em]"
              >
            ...
            <div className="mt-8 text-center text-[12px] text-[var(--soft)]/50 font-medium">
              Existing operator?{" "}
              <Link href="/login" className="text-[var(--cyan)] hover:text-[var(--mint)] font-bold transition-colors">
                Sign In to Terminal
              </Link>
            </div>
          </div>
