...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#080a14] relative overflow-hidden font-sans">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-gradient-radial from-violet-600/15 via-indigo-600/5 to-transparent rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-1/4 w-[400px] h-[300px] bg-gradient-radial from-indigo-600/10 to-transparent rounded-full blur-3xl pointer-events-none animate-float" />
